:partner-solution-project-name: quickstart-dynatrace
:partner-solution-github-org: aws-quickstart
:partner-product-name: Managed Cluster on the AWS Cloud
:partner-product-short-name: Managed Cluster
:partner-company-name: Dynatrace
:doc-month: August
:doc-year: 2023
